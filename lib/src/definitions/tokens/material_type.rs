...
impl std::fmt::Display for MaterialTypeToken {
...
impl IsEmpty for MaterialTypeToken {
    fn is_empty(&self) -> bool {
        self == &MaterialTypeToken::Unknown
    }
}
