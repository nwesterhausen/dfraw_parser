 ...
 */
{ BiomeSupport: { biome: string; frequency: number } } | 
/**
 * Arguments: biome
 * 
 ...
 */
{ MaxSitePopNumber: { number: number } } | 
/**
 * Arguments: number
 * 
 ...
 */
{ MaxStartingCivNumber: { number: number } } | 
/**
 ...
 */
{ Currency: { material: string; value: number } } | 
/**
 ...
 */
{ ArtFacetModifier: { modifier: string; number: number } } | 
/**
 ...
 */
{ ArtImageElementModifier: { item: string; number: number } } | 
/**
 * Arguments: item, number
 * 
 ...
 */
{ ItemImprovementModifier: { item: string; number: number } } | 
/**
 * Arguments: language
 * 
 ...
 */
{ SphereAlignment: { sphere: string; number: number } } | 
/**
 ...
 */
{ Value: { value: string; strength: number } } | 
/**
 ...
 */
{ VariableValue: { value: string; min: number; max: number } } | 
/**
 ...
 */
{ ProgressTriggerPopulation: { level: number } } | 
/**
 * Arguments: level
 * 
 ...
 * Progress triggers may be changed, added, or deleted for a currently active fort.
 */
{ ProgressTriggerProduction: { level: number } } | 
/**
 * Arguments: level
 * 
 ...
 * Progress triggers may be changed, added, or deleted for a currently active fort.
 */
{ ProgressTriggerTrade: { level: number } } | 
/**
 * Arguments: level
 * 
 ...
 */
{ ProgressTriggerPopulationSiege: { level: number } } | 
/**
 * Arguments: level
 * 
 * 0 to 5, civ will begin to send sieges against the player civ when this level is reached if it is hostile.
 ...
 * waiting for all of them to be reached. A value of 0 disables the trigger
 */
{ ProgressTriggerProductionSiege: { level: number } } | 
/**
 * Arguments: level
 * 
 * 0 to 5, civ will begin to send sieges against the player civ when this level is reached if it is hostile.
 ...
 * waiting for all of them to be reached. A value of 0 disables the trigger
 */
{ ProgressTriggerTradeSiege: { level: number } } | 
/**
 ...
 */
{ TissueStyleMaintainLength: { min: number; max: number } } | 
/**
 ...
 */
{ Commander: { position: string; commanded_position: string } } | 
/**
 ...
 * will move in.
 */
{ RequiresPopulation: { population: number } } | 
/**
 ...
 */
{ Squad: { headcount: number; singular: string; plural: string } } | 
/**
