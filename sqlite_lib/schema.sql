CREATE TABLE module_locations (id INTEGER PRIMARY KEY, name TEXT NOT NULL);
...
CREATE TABLE steam_metadata (module_id INTEGER NOT NULL, metadata TEXT);
...
CREATE TABLE module_restriction_rules (id INTEGER PRIMARY KEY, name TEXT NOT NULL);
...
CREATE TABLE raw_types (id INTEGER PRIMARY KEY, name TEXT NOT NULL);
...
CREATE UNIQUE INDEX idx_raw_definitions_unique_identifier ON raw_definitions (module_id, identifier);
